...
// если одну букву в первом слове можно заменить на некоторую букву 
...
// буква может не меняться, а остаться такой же. (Например, note - 
// code)
// Пример 1:
// Input: s = "foo", t = "bar"
// Output: false
...
public class Task2 {
    ...
    static boolean ex1(String s1, String s2){
        System.out.println(ex1("title", "paper"));
