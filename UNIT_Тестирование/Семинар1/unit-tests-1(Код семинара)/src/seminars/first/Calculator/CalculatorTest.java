...
public class CalculatorTest {
    ...
    public void testCalculatingDiscount() {
        ...
        double result = calculator.calculatingDiscount(100.0, 10.0);
        assertThat(result).isEqualTo(90.0);

        double resultZero = calculator.calculatingDiscount(0.0, 30.0);
        assertThat(resultZero).isEqualTo(0.0);

        assertThatThrownBy(() -> calculator.calculatingDiscount(-100.0, 15.0))
                .isInstanceOf(ArithmeticException.class)
                .hasMessage("Invalid arguments");

        assertThatThrownBy(() -> calculator.calculatingDiscount(120.0,130.0))
                .isInstanceOf(ArithmeticException.class)
                .hasMessage("Invalid arguments");
    }
